    ...
    public class LocationAnalysisDashboardViewModel : ViewModelBase
    {
        ...
        public int StnIndex
        {
            ...
            set
            {
                ...
                this.OnPropertyChanged(nameof(this.StnIndex));
            }
        }
        ...
        public bool StnFilter
        {
            ...
            set
            {
                ...
                this.OnPropertyChanged(nameof(this.StnFilter));
                this.OnPropertyChanged(nameof(this.StnCollection));
                this.OnPropertyChanged(nameof(this.StnIndex));
            }
        }
        ...
        public bool FullList
        {
            ...
            {
                this.fullList = value;
                this.OnPropertyChanged(nameof(this.FullList));
            }
        }
