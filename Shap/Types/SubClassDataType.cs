namespace Shap.Types
{
  ...
  public class SubClassDataType : ViewModelBase, ISubClassDataType
  {
    private string imageName;
    private ObservableCollection<VehicleNumberType> m_numberList = new ObservableCollection<VehicleNumberType>();
...
//      return System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().GetName().CodeBase);
    ...
    /// Index for the list of sub class image lists.
    /// </summary>
    public ObservableCollection<VehicleNumberType> VehicleNumbersList
    {
      get
      {
    ...
    public ObservableCollection<string> NumbersList
    {
      get
      {
        ...
        foreach(VehicleNumberType number in this.VehicleNumbersList)
        {
    ...
    public bool AddCurrentNumber(int currentNumber)
    {
      ...
      if (success)
      {
        VehicleNumberType localVehicleNumber = new VehicleNumberType(currentNumber);
    ...
    public void AddNumber(VehicleNumberType newNumber)
    {
    ...
    public void RemoveNumber(VehicleNumberType oldNumber)
    {
    ...
    {
      m_numberList =
       new ObservableCollection<VehicleNumberType>(
    ...
    public ObservableCollection<int> GetAllNumbers()
    {
      ...
      foreach (VehicleNumberType vehicleNumbers in this.VehicleNumbersList)
      {
