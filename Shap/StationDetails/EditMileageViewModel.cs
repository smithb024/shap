namespace Shap.StationDetails
{
  ...
  public partial class EditMileageViewModel : ViewModelBase
  {
    ...
    public EditMileageViewModel()
    {
      ...
      this.CloseWindowCmd = new EditViewModelCmd(this, this.CloseWindow);
      this.AddNewCmd = new EditViewModelCmd(this, this.AddNewRoute);
      this.CompleteEditCmd = new EditViewModelCmd(this, this.CompleteUpdate);
      this.RefreshCmd = new EditViewModelCmd(this, this.InitialiseEditTab);
      this.SelectForEditCmd = new EditViewModelCmd(this, this.SelectJourneyToEdit, this.CanJnyBeSelected);
    }
