namespace Shap.Config
{
  ...
  public class ConfigViewModel : ViewModelBase
  {
      ...
      FirstExampleManager firstExamples)
    {
      ...
      this.CloseCmd = new ConfigFormCmd(this, this.CloseWindow);
      this.RefreshYearCmd = new ConfigFormCmd(this, this.RefreshYear);
      this.RefreshAllCmd = new ConfigFormCmd(this, this.RefreshAll);
      this.ConfigClsCmd = new ConfigFormCmd(this, this.ConfigCls);
      this.ConfigStnCmd = new ConfigFormCmd(this, this.ConfigStn);
      this.UpdatePreviousIdCountCmd = new ConfigFormCmd(this, this.UpdatePreviousIdCount);
    }
