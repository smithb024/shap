namespace Shap
{
  ...
  public class MainWindowViewModel
  {
      ...
      FirstExampleManager firstExamples)
    {
      ...
      //this.dailyInputFactory = dailyInputFactory;

      AddEditJnyDetailsCommand = new DisplayWindowCmd(this, ShowAddEditJnyDetailsWindow);
      AnalysisCommand = new DisplayWindowCmd(this, ShowAnalysisWindow);
      ConfigurationCommand = new DisplayWindowCmd(this, ShowConfigurationWindow);
      ExitCommand = new DisplayWindowCmd(this, ExitProgram);
      OpenLogCommand = new DisplayWindowCmd(this, ShowLog);
      OpenLogFolderCommand = new DisplayWindowCmd(this, ShowLogFolder);
      ShowClassIndexCommand = new DisplayWindowCmd(this, ShowClassIndexWindow);
      ShowJnyDetailsCommand = new DisplayWindowCmd(this, ShowJnyDetailsWindow);
      ShowInputDataCommand = new DisplayWindowCmd(this, ShowInputWindow);
